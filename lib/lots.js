...
// ! This readme should be improved #documentation
...
function searchTickets(directory, exclude, todos, cb) {
  // This version makes priority required
  // var cmd = 'cd ' + directory +';grep -H -n -R -I "\\!" * ' + exclude + ' | grep "#" | grep "\\^[0-9]"';
